...
unsigned char** filtro2(unsigned char **original, int x, int y,int jan){
    ...
    matriz = (unsigned char *) malloc( jan * jan * sizeof(unsigned char));
    ...
    for(int linha = aux; linha < x + aux; linha++){
	    for(int coluna = aux; coluna < y + aux; coluna++){
			...
			M[linha][coluna] = matriz[jan*jan/2];
			k=0;
			soma = 0;
		}
    }
...
void printFim(){
    ...
    printf("////////////////////#8#8#####88####88&&8(((((((((((((((((((\n");
    printf("///////////////////###################8&8(//((/((((((((((((\n");
    printf("///////////////////8#8&&&&88#####8888888&(//((//(((((((((((\n");
    printf("///////////////////#8&&@@&&888&&&&8888888/(////((/(((((((((\n");
    printf("//////////////////##8(  )###8&&(  )@&@&&&/////////(((((((((\n");
    printf("/////////////////(####8######888&&&&&&8&8/////////(///(((((\n");
    printf("//////////////////###8888&8888888888888&/////////////((/(((\n");
    printf("/////////////////(#######8(((&&&8888888#///////////////((((\n");
    printf("////////(/(/(////(888&&&&&&&&&&&&88888#////////////////(/((\n");
    printf("///(((/(((((((((//888888#########&&&&8(////////////////((((\n");
    printf("///((/(((((/((((//#888&&########&&&&&(////////////////(((((\n");
    ...
    printf("///(((((((/,,,.,,,*....,,.,,...,,,,(@@@@&888&&&&&*,,.,(((((\n");
    printf("(/((((((((,,,..,,,.,.,,,,...,,,,,,,**&888888&&8&&&&&(,(((((\n");
    printf("/((((((//.,*     *ESTUDA GALERA.*    8&*  #8. &8@&.8##.((((\n");
    printf("/((((((((,,..,...*.,..,,,,,,,(&@@@88888888888&&8&888#(8((((\n");
    printf("(((((((((,.......,,,,,,,,.,,,,,,*/@&8888888&88888&&88/&((((\n");
...
void printIntro(){
    ...
    printf("| $$  | $$                | $$    $$                | $$                        | $$  \n");
    printf("| $$  | $$       /$$      |  $$$$$$/       /$$      | $$             /$$       /$$$$$$\n");
    printf("|__/  |__/      |__/      |_______/       |__/      |__/            |__/      |______/\n\n");

	printf("-----APLICAÇÃO DE CONSOLE PARA PROCESSAMENTO DE IMAGENS-------\n----------------------------------------------------\n--------------BY JOEL,NIVARDO AND YVES.-------------\n\n\n");
